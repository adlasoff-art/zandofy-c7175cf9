...
export type PeriodKey = "today" | "24h" | "48h" | "7d" | "14d" | "30d" | "3m" | "6m" | "9m" | "1y" | "all";
...
export const PERIOD_OPTIONS: { value: PeriodKey; label: string; days: number }[] = [
  ...
  { value: "48h", label: "48 heures", days: 2 },
  ...
  { value: "1y", label: "12 mois", days: 365 },
  { value: "all", label: "Tout", days: 99999 },
];
...
export function getPeriodDate(period: PeriodKey): Date | null {
