...
export const VENDOR_TIERS = {
  beginner: {
    ...
    maxCollaborators: 2,
    maxPromos: 10,
    features: ["Catalogue gratuit (100 produits)", "Commission plateforme", "Statistiques basiques"],
  ...
  intermediate: {
    ...
    maxCollaborators: 2,
    maxPromos: 15,
    features: ["Catalogue étendu (200 produits)", "Statistiques basiques", "Coupons"],
