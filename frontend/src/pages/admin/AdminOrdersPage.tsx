                ...
                <div key={o.id}>
                  ...
                  {isExpanded && (
                    <div className="px-4 pb-4 space-y-3 bg-muted/10">
                      ...
                      <div className="flex flex-wrap gap-1.5 text-[10px]">
                        {o.payment_method && (
                          <span className="px-2 py-0.5 rounded-full bg-muted font-medium">
                            Paiement : {o.payment_method === "mobile_money" ? "Mobile Money" : o.payment_method === "cod" ? "Cash à la livraison" : o.payment_method === "off_platform" ? "Hors plateforme" : o.payment_method === "whatsapp" ? "WhatsApp" : o.payment_method}
                          </span>
                        )}
                      ...
                      {(o.payment_method === "off_platform" || o.payment_method === "whatsapp") &&
